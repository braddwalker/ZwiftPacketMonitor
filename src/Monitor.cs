...
namespace ZwiftPacketMonitor
{
    ...
    public class Monitor
    {
        ...
        private readonly CompanionPacketDecoder _companionPacketDecoder;
        ...
        private void DeserializeAndDispatchCompanion(byte[] buffer, Direction direction, uint sequenceNumber)
        {
            ...
            {
                _companionPacketDecoder.DecodeIncoming(buffer, sequenceNumber);
            }
            else if (direction == Direction.Outgoing)
            {
                _companionPacketDecoder.DecodeOutgoing(buffer, sequenceNumber);
            }
        }
